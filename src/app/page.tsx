...
const GUEST_NOTES: GuestNote[] = [
  {
    ...
    date: "March 2024",
    message:
      "The most breathtaking snorkel of my life. The coral gardens near Hikkaduwa felt like stepping into a dream. Aloha's team made everything effortless — pure magic.",
    rotation: -3,
    x: 0,
    y: 0,
  },
  {
    ...
    date: "January 2024",
    message:
      "Three dives, three different worlds. The shipwreck at sunrise was something I'll carry forever. Thank you Aloha for making it safe and extraordinary.",
    rotation: 2,
    x: 0,
    y: 0,
  },
  {
    ...
    date: "February 2024",
    message:
      "Surfing lessons at Hikkaduwa — from zero to riding waves in one morning! The instructors have infinite patience and genuine passion. Already booking next year.",
    rotation: -1.5,
    x: 0,
    y: 0,
  },
  {
    ...
    date: "April 2024",
    message:
      "Our anniversary fishing trip at dawn was perfect. Caught our first tuna together. The crew celebrated with us like family. This place is special.",
    rotation: 2.5,
    x: 0,
    y: 0,
  },
...
const PARTNERS: Partner[] = [
  { id: 1, name: "PADI Certified" },
  { id: 2, name: "Sri Lanka Tourism" },
  { id: 3, name: "SSI Global" },
  { id: 4, name: "Ocean Alliance" },
  { id: 5, name: "Eco Dive Lanka" },
  { id: 6, name: "Blue Planet Fund" },
  { id: 7, name: "Reef Guardian" },
  { id: 8, name: "Indo-Pacific Marine" },
];
...
function GoldDivider({ className = "" }: { className?: string }) {
  return (
    <div className={`flex items-center gap-4 ${className}`}>
      <div className="h-px bg-[#D4AF37] flex-1 opacity-50" />
      <div className="w-1.5 h-1.5 bg-[#D4AF37] rotate-45 opacity-80" />
      <div className="h-px bg-[#D4AF37] flex-1 opacity-50" />
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <SectionLabel>Hikkaduwa · Sri Lanka · Est. 2010</SectionLabel>
        </motion.div>
        ...
        >
          <p
            ...
            style={{ fontFamily: "var(--font-inter, sans-serif)" }}
          >
            Where the Indian Ocean reveals its most extraordinary secrets to
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between mb-16 gap-6">
          ...
          <RevealBlock delay={0.2} className="lg:max-w-xs">
            <p
              ...
              style={{ fontFamily: "var(--font-inter, sans-serif)" }}
            >
              Four carefully curated water sports experiences, each crafted to
              deliver the extraordinary. No two sessions are alike.
            </p>
          </RevealBlock>
        </div>
    ...
    >
      ...
      >
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.pexels.com/photos/30375548/pexels-photo-30375548.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=1200&w=800')",
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-20 relative">
        <div className="max-w-2xl">
          ...
          <RevealBlock delay={0.2}>
            ...
            >
              Nestled on the southwestern coast, Hikkaduwa sits at the
              intersection of culture, luxury, and raw natural wonder. The coral
              sanctuary here — one of the most pristine in the Indian Ocean —
              shelters over 170 species of reef fish and a permanent colony of
              sea turtles.
            </p>
          </RevealBlock>
          ...
          <RevealBlock delay={0.3}>
            ...
            >
              The Indian Ocean here breaks with legendary consistency from
              November through April. When the monsoon recedes, it leaves
              crystalline waters and visibility stretching beyond 20 metres.
              This is where Aloha calls home.
            </p>
          </RevealBlock>
          ...
          <RevealBlock delay={0.4}>
            <div className="grid grid-cols-3 gap-6">
              {[
                { label: "Years Operating", value: "16+" },
                { label: "Guests Served", value: "8,200+" },
...
function GuestNoteCard({ note, index }: { note: GuestNote; index: number }) {
  const ref = useRef<HTMLDivElement>(null);
  const isInView = useInView(ref, { once: true, margin: "-40px" });

  const colors = [
    { bg: "#faf5e9", accent: "#8B6914" },
    { bg: "#f0ebe0", accent: "#5C4A2A" },
    { bg: "#f7f2e6", accent: "#7A5C2A" },
    { bg: "#ece6d4", accent: "#6B4F28" },
  ];
  ...
  return (
    <motion.div
      ...
      dragMomentum={false}
      dragElastic={0.05}
      initial={{ opacity: 0, y: 60, rotate: note.rotation - 5 }}
      animate={
        isInView
          ? {
              opacity: 1,
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          boxShadow:
            "0 4px 15px rgba(0,0,0,0.4), 0 20px 50px rgba(0,0,0,0.5), inset 0 0 0 1px rgba(0,0,0,0.06)",
          maxWidth: "260px",
          minHeight: "280px",
        }}
      >
...
function GuestNotesSection() {
  return (
    <section className="relative z-10 bg-[#0E2129] py-24 lg:py-36 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-20">
        <div className="mb-16">
          <RevealBlock>
            <SectionLabel>Handwritten Memories</SectionLabel>
          </RevealBlock>
          <RevealBlock delay={0.1}>
            <h2
              className="text-white leading-none"
          ...
          <RevealBlock delay={0.2} className="mt-4 max-w-sm">
            <p
              className="text-white/30 text-xs tracking-[0.2em] uppercase"
              style={{ fontFamily: "var(--font-inter, sans-serif)" }}
            >
              Drag the notes · Real words from real adventurers
            </p>
          </RevealBlock>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-6 place-items-center lg:place-items-start">
          {GUEST_NOTES.map((note, i) => (
            <div key={note.id} className="relative">
              <GuestNoteCard note={note} index={i} />
            </div>
          ))}
        </div>
      </div>
...
function ReviewCard({ review, index }: { review: Review; index: number }) {
  ...
  return (
    <motion.div
      ...
      style={{
        background:
          "linear-gradient(135deg, rgba(14,33,41,0.8) 0%, rgba(10,10,10,0.9) 100%)",
        boxShadow:
    ...
    <section className="relative z-10 bg-[#0E2129] py-14 overflow-hidden">
      ...
      <div className="text-center mb-8">
        <span
          ...
          style={{ fontFamily: "var(--font-inter, sans-serif)" }}
        >
          The Flow · Trusted Partners & Certifications
        </span>
      </div>
      ...
      <div className="relative px-6 sm:px-12 lg:px-20 pt-24 lg:pt-36 pb-16">
        ...
        >
          <div
            ...
            style={{
              backgroundImage:
                "url('https://images.pexels.com/photos/11635632/pexels-photo-11635632.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=800&w=1600')",
